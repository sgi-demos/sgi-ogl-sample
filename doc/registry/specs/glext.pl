...
#
# $Date: 2004/03/01 18:38:28 $ $Revision: 1.4 $
# $Header: /oss/CVS/cvs/projects/ogl-sample/main/doc/registry/specs/glext.pl,v 1.4 2004/03/01 18:38:28 ljp Exp $
#
...
# Windows cruft
print "#if defined(_WIN32) && !defined(APIENTRY) && !defined(__CYGWIN__) && !defined(__SCITECH_SNAP__)\n";
...
print "#endif\n";
print "#ifndef APIENTRYP\n";
print "#define APIENTRYP APIENTRY *\n";
print "#endif\n";
print "#ifndef GLAPI\n";
print "#define GLAPI extern\n";
print "#endif\n";
print "\n";
